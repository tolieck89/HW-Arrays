...
for (element of users){
    sum_balances+=element.balance;
    if (element.balance>2000){
        phone_numbers.push(element.phone);
    }
}

document.write(`
    <p>Загальна сума балансів усіх користувачів складає ${sum_balances} доларів.  </p>
    <p>Баланс більш ніж 2000 доларів мають наступні номери: </p>
    `)
for (el of phone_numbers){
